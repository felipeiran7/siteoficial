<?php if(!class_exists('Rain\Tpl')){exit;}?></header>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h3>Aulas ao vivo com o melhor time da cidade</h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tutors-slide owl-carousel wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="single-tutors-slides">
                            ...
                            <div class="tutor-thumbnail">
                                <img src="/res/site/img/bg-img/t1.png" alt="">
                            </div>
                            <!-- Tutor Information -->
                        ...
                        <div class="single-tutors-slides">
                            <!-- Tutor Thumbnail -->
                            <div class="tutor-thumbnail">
                                <img src="/res/site/img/bg-img/t2.png" alt="">
                            </div>
                            <!-- Tutor Information -->
                            <div class="tutor-information text-center">
                        ...
                        <div class="single-tutors-slides">
                            <!-- Tutor Thumbnail -->
                            <div class="tutor-thumbnail">
                                <img src="/res/site/img/bg-img/t3.png" alt="">
                            </div>
                            <!-- Tutor Information -->
                            <div class="tutor-information text-center">
                                <h5>A.J Farias</h5>
                        ...
                        <div class="single-tutors-slides">
                            <!-- Tutor Thumbnail -->
                            <div class="tutor-thumbnail">
                                <img src="/res/site/img/bg-img/t4.png" alt="">
                            </div>
                            <!-- Tutor Information -->
                            <div class="tutor-information text-center">
                                <h5>Marquesluís</h5>
                        ...
                        <div class="single-tutors-slides">
                            <!-- Tutor Thumbnail -->
                            <div class="tutor-thumbnail">
                                <img src="/res/site/img/bg-img/t5.png" alt="">
                            </div>
                            <!-- Tutor Information -->
                            <div class="tutor-information text-center">
                                <h5>Saul Filho</h5>
    ...
    <section class="register-now section-padding-100-0 d-flex justify-content-between align-items-center"  style="background-image: url(/res/site/img/bg-img/bg1.jpg);" id= "session_cad">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="single-blog-area mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="/res/site/img/blog-img/1.jpg" alt="">
                        <!-- Blog Content -->
                        <div class="blog-content">
                            <a href="#" class="blog-headline">
                                <h4>TURMA MEDICINA</h4>
                            </a>
                            <div class="meta d-flex align-items-center">
                                <a href="#">Turma Intensiva</a>
                ...
                <div class="col-12 col-md-6">
                    <div class="single-blog-area mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <img src="/res/site/img/blog-img/2.jpg" alt="">
                        <!-- Blog Content -->
                        <div class="blog-content">
                            <a href="#" class="blog-headline">
                                <h4>TURMA CFO-ENEM</h4>
                            </a>
                            <div class="meta d-flex align-items-center">
                                <a href="#">Turma Intensiva</a>
                                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
