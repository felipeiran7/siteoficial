...
<body>
    ...
    <header>
            ...
            <nav class="navbar navbar-dark bg-primary navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbar">
                    <ul class="navbar-nav mr-auto ml-auto" id="menu-items">
                        <li class="nav-item">
                            <a href="/admin/login" class="nav-link">Home</a>    
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="login-state d-flex align-items-center">
                        <div class="user-name mr-30">
                            <div class="dropdown">
                                <a class="dropdown-toggle text-white" href="#" role="button" id="userName" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user-circle-o"></i><!--{function="getUserNameSession()"}</a> -->
        ...
        <button id="btn-ative-cad" type="button" class="btn btn-primary">Cadastrar</button>
</body>
